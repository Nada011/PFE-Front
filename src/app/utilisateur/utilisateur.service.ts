...
public createUser(utilisateur:Utilisateur):Observable<Utilisateur>{
  return this.http.post<Utilisateur>(`${this.apiServerUrl}/Admin/user/add`,utilisateur);
}
public updateUsers(utilisateur:Utilisateur):Observable<Utilisateur>{
  return this.http.put<Utilisateur>(`${this.apiServerUrl}/Admin/user/update`,utilisateur);
}
public deleteUser(utilisateurId:number):Observable<void>{
  return this.http.delete<void>(`${this.apiServerUrl}/Admin/user/delete/${utilisateurId}`);
}
}
