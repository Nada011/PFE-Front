...
const html5QrcodeSupportedFormatsTextMap: Map<
...
export class Html5QrcodeConstants {
  static GITHUB_PROJECT_URL: string = 'https://github.com/mebjas/html5-qrcode';
...
export class QrcodeResultFormat {
  ...
  private constructor(format: Html5QrcodeSupportedFormats, formatName: string) {
    this.format = format;
  ...
  public static create(format: Html5QrcodeSupportedFormats) {
    ...
    return new QrcodeResultFormat(
      format,
      html5QrcodeSupportedFormatsTextMap.get(format)!
    );
  }
}
